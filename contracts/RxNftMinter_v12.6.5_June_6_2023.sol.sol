...
// ***********v.12.7*************************************
    struct UtilsStorage {
        ...
        string date_current_filled_formatted;
...
// ***** v11.7 ***************
        ...
        // _pharmacyFillScript(_date_current_fill, _date_next_fill, _script_status, _active, _fill_id, _fill_date, tokenId);
...
// ***** v11.7 ***************
    ...
    function _pharmacyFillScript(
        string memory _current_fill_date,
        ...
        PharmacyFills memory _fill = Receipt({
            date_current_fill: _current_fill_date,
    ...
    function jsonMetaDataTwo(uint256 tokenId) public view returns (string memory) {
        ...
        //     bytes(
                ...
                // '",',
                        ...
                        // '"},{"trait_type":"dateprescribed","value":"',getDatePrescribed(tokenId),
                        '{"trait_type":"dateprescribed","value":"',getDatePrescribed(tokenId),
                        '"},{"trait_type":"datefilled","value":"',getDateFilled(tokenId),
        ...
        //     bytes(
                string(
                    abi.encodePacked(
                        ...
                        // '"},{"trait_type":"dateprescribed","value":"',getDatePrescribed(tokenId),
                        '{"trait_type":"original-fill-date","value":"',getOriginalFillDate(tokenId),
    // '"},{"trait_type":"extra-spot","value":"',getExtraSpot(tokenId),
        ...
        //     bytes(
                ...
                // '",',
                        ...
                        '"},{"trait_type":"doctordea","value":"',getDoctorDea(tokenId),   
...
// (5/23/23) - Last Working tokenURI function intact ***********************************************
    ...
    function updateScriptQuantityAndDatesRoles(uint256 tokenId, uint256 _pillsFilled, string memory _dateFilled, 
    string memory _dateNextFill, string memory _pharmacyName) 
        public onlyPharmacy {
            Script storage rx = allScripts[tokenId];
...
// PHARMACY FILLS Struct Functions
    ...
    function getOriginalFillDate(uint256 tokenId) public view returns (string memory) {
        PharmacyFills storage fill = allPharmacyFills[tokenId];
        return fill.original_fill_date;  
    } 
