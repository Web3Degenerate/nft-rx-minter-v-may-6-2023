    ...
    function jsonMetaDataTwo(uint256 tokenId) public view returns (string memory) {
        ...
        //     bytes(
                ...
                // '",',
                        ...
                        // '"},{"trait_type":"dateprescribed","value":"',getDatePrescribed(tokenId),
                        '{"trait_type":"doctor","value":"',getDatePrescribed(tokenId),
                        '{"trait_type":"doctordea","value":"',getDatePrescribed(tokenId),
                        '"},{"trait_type":"physicaladdress","value":"',getDateFilled(tokenId)
