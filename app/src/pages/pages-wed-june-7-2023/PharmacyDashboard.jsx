                ...
                {nfts?.length > 0 ?
                    ...
                    return search.toLowerCase() === '' ? nft : nft.metadata.name.toLowerCase().includes(search) || nft.metadata.attributes[0].value.toLowerCase().includes(search)
                            ...
                            <tr key={`${index}`}>
                                ...
                                <td>   {nft.metadata.attributes[5].value === 'N/A' && nft.metadata.attributes[5].value === '' ? (
                                        <>
                                            {nft.metadata.attributes[5].value}
                                        </>
                                        ) : (
                                        <>
                                            {formatDateTwoDigitYear(nft.metadata.attributes[5].value)}
                                        </>
                                        )}
                                </td>

                                <td>{formatDateTwoDigitYear(nft.metadata.attributes[6].value)}</td>


                                <td>{formatDateTwoDigitYear(nft.metadata.attributes[7].value)}</td>
