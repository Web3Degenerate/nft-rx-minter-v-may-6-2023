...
//useRef() remove lag solution: https://dev.to/kevinkh89/how-to-solve-input-delay-lagging-in-react-j2o
  ...
  try {
    ...
    const data = await contract.call("_createScript", [wallet_address, name, description_Ref, medication_Ref, dob, quantity_Ref, date_prescribed_Ref, new Date(date_prescribed_Ref).getTime()])
