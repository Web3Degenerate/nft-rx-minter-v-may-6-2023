                ...
                <div className={selectedNFT == nft.metadata.id ? 'contento show' : 'contento'}>
                      <div key={nft.metadata.id.toString()} className="view-scripts-card text-left">
                              ...
                              />
                                  ...
                                  <p><b>Patient:</b> {nft.metadata.name} | <b>DOB:</b> {nft.metadata.dob}</p>
                                  ...
                                  <p><b>Qty Filled:</b> {nft.metadata.quantityfilled} | <b>Date Filled:</b> {nft.metadata.datefilled}</p>
                                  <p className="text-left"><b>Next Fill Date:</b> {nft.metadata.datenextfill}</p>
...
{/* ****************************************************************************************************** */}
                     <br></br>
                                  ...
                                  {address && nft.owner == address ? 
                                    `Quantity Filled: 0/${nft.metadata.quantity}.` : 
