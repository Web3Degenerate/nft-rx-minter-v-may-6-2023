...
// 6/8/23 - NEXT FILL DATE NOT updatedNextFillDate but RATHER '${formatDateTwoDigitYear(dynamicNextFillRef.current)}' so it can be override if needed: ********
            ...
            alert(`Success! Quantity of ${pills_filled_Ref} pills on ${formatDateTwoDigitYear(dynamicSetFillDate)} has been filled by ${pharmacy_name}. Next refill date is ${formatDateTwoDigitYear(dynamicNextFillRef.current)}.`);
                        ...
                        <div className="card" style={{width: "18rem;"}}>
                            ...
                            <div className="card-body">
                                ...
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="list-group-item"><b>Prescriber:</b> {nftz?.metadata.attributes[8].value} </li>
                                    <li className="list-group-item"><b>DEA #:</b> {nftz?.metadata.attributes[9].value} </li>
                                    
                                    <li className="list-group-item"><b>SIG:</b> {nftz?.metadata.description}</li>
                                    <li className="list-group-item"><b>Date Prescribed:</b> {formatDateFourDigitYear(nftz?.metadata.attributes[5].value)}</li>
