...
// Original idea for useRef came from: https://dev.to/kevinkh89/how-to-solve-input-delay-lagging-in-react-j2o
  ...
  import { addyShortner, formatDateFourDigitYear, formatDateTwoDigitYear, dayCalculatorDoc, convertNumberDateToRawString, convertBigNumberToFourDigitYear } from '../utils'
    ...
    {/* <form onSubmit={handleSubmit}> */}
                    ...
                    <div className="row">
                        <div className="col-md-12 text-center">
                            ...
                            <h5>{displayDateUintTest}</h5> 
                            <h5>{formatDateTwoDigitYear(convertDateNumberTest)}</h5>
...
<>
        ...
        <h3>Potential Conflicts For Patient: {name} as of {formatDateFourDigitYear(newPstDate)}</h3>
      ...
      {fillEvents?.length > 0 ? 
                  fillEvents.filter((eventz) => {
                      return eventz.data.next_available_fill_date > newPstDate || eventz.data.quantity_unfilled.toNumber() != 0
                    }
                        ...
                        <tr key={`${index}`}>
                            ...
                            <td className="text-center">{eventz.data.script_token_number.toNumber()}</td>
